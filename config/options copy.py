...
parser.add_argument('--train_file',type=str, default='/DATA/DATA1/wjr/mintiqa/mytraindict_llm.json')
parser.add_argument('--test_file',type=str, default='/DATA/DATA1/wjr/mintiqa/mytestdict_llm.json')
parser.add_argument('--imgpath',type=str, default='/DATA/DATA3/wjr/AIGCIQA2023')
# parser.add_argument('--logfile_name', type=str, default='overall_csa', help='Name of the log file.')
parser.add_argument('--logfile_name', type=str, default='my_3scores_pre_lora')
