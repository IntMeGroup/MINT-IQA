...
def make_path():
    return "{}_bs{}_fix={}_lr={}{}".format(opts.savepath, opts.batch_size, opts.fix_rate, opts.lr, opts.lr_decay_style)
def make_path2():
    return "{}_bs{}_fix={}_lr={}{}srcc".format(opts.logfile_name, opts.batch_size, opts.fix_rate, opts.lr, opts.lr_decay_style)
def make_path3():
    return "{}_bs{}_fix={}_lr={}{}loss".format(opts.logfile_name, opts.batch_size, opts.fix_rate, opts.lr, opts.lr_decay_style)
def make_path_llm():
    return "{}_bs{}_fix={}_lr={}{}llm".format(opts.logfile_name, opts.batch_size, opts.fix_rate, opts.lr, opts.lr_decay_style)
